...
export class ProjectsComponent {
  ...
  projects = [
    ...
    { id: 'project2', title: 'Property Price Predictor', year: '2024-2025', tech: 'Python', image: 'assets/project-thumbnail_Property.png' },
    { id: 'project3', title: 'Home Field Advantage', year: '2024-2025', tech: 'Python', image: 'assets/project-thumbnail_HFA.png' },
    ...
    { id: 'project6', title: 'Personal Portfolio Website', year: '2024', tech: 'Angular', image: 'assets/project-thumbnail5.png' },
  ];
